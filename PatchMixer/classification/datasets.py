import os
from datasets_mn40 import dataset_mn40, dataset_mn4011, dataset_mn407, dataset_mn4010
from datasets_sonn import dataset_sonn, dataset_sonn11
from datasets_pointda import dataset_modelnet10, dataset_modelnet7, dataset_shapenet10, dataset_shapenet7, dataset_scannet10, dataset_scannet7
...
def get_dataset(args, split, transforms):
    ...
    # Transfer learning
    elif args.dataset_type == 'modelnet7':
        dataset = dataset_mn407(args, split, transforms)
    elif args.dataset_type == 'mn4010':
        dataset = dataset_mn4010(args, split, transforms)
    elif args.dataset_type == 'shapenet7':
        dataset = dataset_shapenet7(args, split, transforms)
    elif args.dataset_type == 'scannet7':
        dataset = dataset_scannet7(args, split, transforms)    
