...
class CDFormer(nn.Module):
    ...
    def forward(self, feats, xyz, offset, batch, neighbor_idx):
        ...
        # print("batch inside cdformer forward ", batch.shape)
        # print("feats inside cdformer forward ", feats.shape)
        # print("neighbor_idx inside cdformer forward ", neighbor_idx.shape)
